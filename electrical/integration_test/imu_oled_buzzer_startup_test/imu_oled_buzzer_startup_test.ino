// IMU + OLED + buzzer integration test for ESP32 Dev Module / NodeMCU-32S.
//
// Wiring:
//   Shared I2C bus:
//     ESP32 SDA -> GPIO21
...
//     GND -> GND
//
// This sketch plays a short startup sound on the passive buzzer, then reads
// MPU6050 gyro values using direct I2C registers, converts gx/gy/gz to rad/s,
// and updates the SH1106 OLED display.
...
void drawStatusScreen(const char *line1, const char *line2) {
  ...
  display.println("IMU OLED BUZZER");
...
void setup() {
  ...
  Serial.println("IMU + OLED + buzzer integration test started");
  ...
  if (!initializeMpu6050()) {
    ...
    drawStatusScreen("Startup sound OK", "Rotate sensor");
  }
}
